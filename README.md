...
get the app created:
    ...
    $ heroku apps:create muni-watch
    Creating muni-watch... done, stack is cedar
    http://muni-watch.herokuapp.com/ | git@heroku.com:muni-watch.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://muni-watch.herokuapp.com deployed to Heroku

    To git@heroku.com:muni-watch.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://muni-watch.herokuap.com
    ["Hello" :from Heroku]
